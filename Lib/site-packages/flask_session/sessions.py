...
class RedisSessionInterface(SessionInterface):
    ...
    def save_session(self, app, session, response):
        ...
        # if not self.should_set_cookie(controller, session):
        #    return
...
class SqlAlchemySessionInterface(SessionInterface):
    """Uses the Flask-SQLAlchemy from a flask controller as a session backend.

    .. versionadded:: 0.2

    :param app: A Flask controller instance.
