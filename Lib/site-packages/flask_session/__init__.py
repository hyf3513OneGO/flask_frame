...
class Session(object):
    ...
    application later::
        ...
        def create_app():
            controller = Flask(__name__)
            sess.init_app(controller)
            return controller

    By default Flask-Session will use :class:`NullSessionInterface`, you
    really should configurate your controller to use a different SessionInterface.
    ...
    def init_app(self, app):
        """This is used to set up session for your controller object.

        :param app: the Flask controller object with proper configuration.
        """
